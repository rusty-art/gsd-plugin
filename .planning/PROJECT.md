...
Based on [GSD 1.40.0](https://github.com/gsd-build/get-shit-done) by TACHES (Lex Christopherson).
...
---
*Last updated: 2026-05-03 — synced upstream GSD 1.40.0 (plugin v2.40.0); local patches preserved in core.cjs + gsd-tools.cjs.*
