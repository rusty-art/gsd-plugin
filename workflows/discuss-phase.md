...
- Read and execute @${CLAUDE_PLUGIN_ROOT}/workflows/discuss-phase-power.md end-to-end
...
**Full step-by-step instructions:** @${CLAUDE_PLUGIN_ROOT}/workflows/discuss-phase-power.md
